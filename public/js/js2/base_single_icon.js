...
spsupport.p = {
    ...
    sfIcon: {
        ...
        icons:  [],
        big: {
           // w: superfish.b.theme==2 ? 121 : (superfish.b.redIcon ? 104 : 95),
           // h: superfish.b.theme==2 ? 40 : (superfish.b.redIcon ? 34 : 25)
            w: (superfish.b.redIcon ? 104 : 95),
            h: (superfish.b.redIcon ? 34 : 25)
        },
        small: {
            // w: superfish.b.theme==2 ? 121 : (superfish.b.redIcon ? 73 : 65),
            // h: superfish.b.theme==2 ? 40 : (superfish.b.redIcon ? 34 : 25)
        ...
        prog: {
            time: 1000,
            node: 0,
            // color: superfish.b.theme==2 ? '#333333' : (superfish.b.redIcon ? '#ffffff' : '#398AFD'),
            color: (superfish.b.redIcon ? '#ffffff' : '#398AFD'),
            opac : (superfish.b.redIcon ? '0.5' : '0.3'),
            e: 0,   /* end */
            //w: superfish.b.theme==2 ? [116, 116] : (superfish.b.redIcon ? [93, 66] : [93, 63]),
            //h: superfish.b.theme==2 ? 30 : 23
        ...
        var sa = spsupport.api;
            if( param == 101 ){ // sys down
        	    ...
        	    if( param == -9741 ){//Received New UserId from server
        		    var userid =  prep[1];
//        	        var dDate = new Date();
//                    spsupport.log(dDate.getTime() + " - Receive new userid from server (" +  prep[2] + ") - " + userid);
...
//        }
    ...
    loadIcons: function() {
        var sp = spsupport.p;
        // var nm = superfish.b.redIcon ? 'ri' : (superfish.b.whiteIcon ? 'wi' : (superfish.b.theme == 2 ? 'al' :  'si'));
            ...
            if ( relTarget != sp.sfIcon.prog.node) {
                ...
                if (sp.sfIcon.prog.node) {
                    ...
                    sp.$(sp.sfIcon.prog.node).css({
                            display: "block",
                            // top: nt + dif - (superfish.b.theme==2 ? 7 : (superfish.b.redIcon ? 5 : (superfish.b.whiteIcon ? 1 : 2))) + "px",
